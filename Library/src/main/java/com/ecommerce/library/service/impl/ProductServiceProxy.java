...
import com.ecommerce.library.model.ProductFactory;
import com.ecommerce.library.model.SingletonLogger;
...
//    }
    ...
    public List<ProductDto> filterHighProducts() {
        SingletonLogger.getInstance().logInfo("filterHighProducts");
        return transferData(productRepository.filterHighProducts());
    }

    @Override
    public List<ProductDto> filterLowerProducts() {
        SingletonLogger.getInstance().logInfo("filterLowerProducts");
